...
export default function Productpage() {
    ...
    <div class="productpage">
      ...
      <div class="pages2">
        ...
        <hr class="line58"/>
        <h6 class="Effects">Effects</h6>
        <p style="/* 2500 reported effects from 525 people */
        ...
        color: #AFAFAF;
        ">2500 reported effects from 525 people</p>
        <div class="gridTable">
    ...
    <script src="https://kit.fontawesome.com/40592924b2.js" crossorigin="anonymous"></script>
